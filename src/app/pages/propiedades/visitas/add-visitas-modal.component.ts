...
@Component({
  ...
  template: `
      ...
      <form #visitAddForm="ngForm" novalidate>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-3">
            ...
            <div class="input-group mail-btn-group">
              ...
              <input type="text" class="form-control" name='propertyId' placeholder="1101" [(ngModel)]="propertyId"
                     (keypress)="onlyNumberKey($event)" [disabled]="isView">
              <span class="input-group-btn">
                <button class="btn btn-info btn-icon" title="Buscar por codigo"
                        [disabled]="propertyId == null || propertyId == ''" (click)="searchProperty()"
                        [disabled]="isView">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-3">
            ...
            <label class="custom-control custom-radio radio-inline">
              <input type="radio" class="custom-control-input" name="bedroomsRadio" [value]="0"
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            ...
            <textarea name="observation" class="form-control" cols="30" rows="4" [(ngModel)]="visit.comments"
    ...
    <div class="modal-footer">
      <button *ngIf="!isView && !isEdit" class="btn btn-success btn-with-icon btn-tn"
              [disabled]="!(visitAddForm.form.valid) || !(visit.customer_id) || !(visit.property_id)"
              (click)="createVisit()"><i class="fa fa-save"></i> Guardar
      </button>
      <button *ngIf="isEdit" class="btn btn-success btn-with-icon btn-tn" [disabled]="!visitAddForm.form.valid"
              (click)="updateVisit()"><i class="fa fa-save"></i> Actualizar
      </button>
      <button class="btn btn-danger btn-with-icon btn-tn" (click)="closeModal()"><i class="fa fa-times-circle"></i>
        Cancelar
      </button>
    </div>
	`,
